...
import 'package:aulanosa_ap/objetosNecesarios/menu_item.dart';
...
class MenuItems2 {
  ...
  static const adminProductos =
      MenuItemm('Productos', Icons.shopping_cart_rounded);
  static const adminProyectos =
      MenuItemm('Proyectos', Icons.assignment_rounded);
  static const adminAlumnosExternos =
      MenuItemm('Alumnos Externos', Icons.groups);
